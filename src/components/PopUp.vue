<template>
  <ul class="w-40 ml-2 text-sm text-white font-semibold sm:absolute top-0 left-80 sm:m-0" id="popup">
    <li class="flex">
      <a class="flex items-center px-3 py-2.5 mb-1.5 bg-black bg-opacity-60 hover:bg-opacity-100 rounded transform hover:translate-x-1 transition duration-75 ease-in" href="#">
        
        <svg class="fill-current h-4 w-4 mr-1.5" viewBox="0 0 20 20">
					<path 
